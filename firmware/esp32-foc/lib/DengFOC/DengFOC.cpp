...
#if ESP_ARDUINO_VERSION_MAJOR >= 3
  ledcAttachChannel(M0_pwmA, 30000, 8, 0);
  ledcAttachChannel(M0_pwmB, 30000, 8, 1);
  ledcAttachChannel(M0_pwmC, 30000, 8, 2);
  ledcAttachChannel(M1_pwmA, 30000, 8, 3);
  ledcAttachChannel(M1_pwmB, 30000, 8, 4);
  ledcAttachChannel(M1_pwmC, 30000, 8, 5);
#else
